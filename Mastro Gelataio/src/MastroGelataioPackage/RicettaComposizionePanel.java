...
public class RicettaComposizionePanel extends JPanel {
	...
	private void CreaBottomPart()
	{
		...
		btnStampa.setFont(new Font("Comic Sans MS", Font.PLAIN, 18));
		add(btnStampa);
	...
	public void CambiaSize(int iX, int iY, int iWidth, int iHeight)
	{
		...
		btnSalva.setBounds(btnSal_X, btnSal_Y, btnSal_Width, btnSal_Height);
		btnStampa.setBounds(btnSta_X, btnSta_Y, btnSta_Width, btnSta_Height);
