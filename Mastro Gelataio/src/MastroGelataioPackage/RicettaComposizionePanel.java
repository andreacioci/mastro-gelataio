...
public class RicettaComposizionePanel extends JPanel {
        ...
        {       
                ...
                /**
                 * Aggiorno le quantit√† dei campi non editabili
                 */
                CalcolaQuantity();
        ...
        /**
         * Viene chiamata quando l'utente cambia il valore di una quantit√† nella tabella
         */
        ...
        /**
         * Viene chiamata quando viene cambiato il valore di una quantit√† nella tabella
         */
        ...
        {
                /**
                 * Se il nome della ricetta non √® stato impostato avviso con una finestra e esco
                 */
                if(txtNomeRicetta.getText().isEmpty() == true)
                {
                        JOptionPane.showMessageDialog(null, "Impossibile salvare la ricetta. Il nome ricetta non √® impostato", "Attenzione", JOptionPane.WARNING_MESSAGE);
                        return;
                }
                ...
                /**
                 * Se nella ricetta non √® stato incluso nessun ingrediente esco subito.
                 */
                if (data == null)
                {
                ...
                /**
                 * Notifico all'utente che il salvataggio Ë avvenuto con successo
                 */
        ...
        public Integer TrovaIDNuovaRicetta()
        {
                ...
                {
                        output++;       /* Devo incrementare di 1 perch√® mi serve il prox ID libero  */
                }
