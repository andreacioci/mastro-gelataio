...
public class ImpostazioniPanel extends JPanel {
        ...
        private void SalvaBase()
        {
                ...
                else
                {
                     ...
                     * una nuova base con un nome gi� esistente.
                     */
                	sCols.clear();
                	objValues.clear();
                	sCols.add("Nome");
                	...
                	if (bModifcaBase == true)
                	{
                		JOptionPane.showMessageDialog(this, "Impossibile salvare la base. Il nome e' gi� in uso", "Attenzione", JOptionPane.WARNING_MESSAGE);
                        return;
                	}
                }
